...
export default function NavMenu({ isOpen } : NavMenuProps) {
  return (
    <div role="dialog" className={`fixed inset-x-0 w-full h-screen bg-gradient-to-b from-black/10  via-black/30 to-black/10 z-10 $ ${isOpen ? 'top-24' : '-top-[45rem] '} transition-all duration-200 ease-in-out lg:hidden `}>
